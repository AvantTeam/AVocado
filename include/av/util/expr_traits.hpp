...
namespace av {
    ...
    struct or_t: std::bool_constant<or_f(T_left, T_right)> {};

    template<bool T_left, bool T_right>
    constexpr bool or_v = or_t<T_left, T_right>::value;

    template<typename T_left, typename T_right,
        typename = typename std::enable_if_t<or_v<std::is_integral_v<T_left>, std::is_floating_point_v<T_right>>>
